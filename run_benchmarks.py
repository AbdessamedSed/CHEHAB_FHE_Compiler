...
benchmark_folders = ["box_blur", "dot_product", "gx_kernel", "gy_kernel", "hamming_dist", "l2_distance", "lin_reg", "poly_reg", "sobel", "roberts_cross"] 
benchmark_folders = ["gx_kernel", "matrix_mul"]
