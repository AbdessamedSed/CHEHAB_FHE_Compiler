...
//  * @param func Shared pointer to the function to be vectorized.
//  */
// void Compiler::gen_vectorized_code (
...
//   // Call the vectorizer function with the computed vector width
//   call_vectorizer(vector_width, rule_filtering, sorting, exp_rules);
...
//   else if (window == 0)
//   {
//     gen_vectorized_code(func, rule_filtering, sorting, exp_rules);
//     return;
//   }
//   else
//   {
...
// {
//   string command = "cargo run --release --manifest-path ../../../egraphs/Cargo.toml -- ../expression.txt " +
//                   to_string(vector_width) + to_string(rule_filtering) + to_string(sorting) +
//                   to_string(exp_rules) + " >> ../vectorized_code.txt";
